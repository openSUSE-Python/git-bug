...
func TestSplitURL(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "default url",
			args: args{
				url: "https://todo.sr.ht/git-bug/git-bug",
			},
			want: want{
				owner:   "git-bug",
				project: "git-bug",
		...
		},
		{
			...
			args: args{
				url: "https://todo.sr.ht/git-bug/git-bug/issues",
			},
			want: want{
				owner:   "git-bug",
				project: "git-bug",
		...
		},
		{
			...
			args: args{
				url: "https://todo.sr.ht/git-bug/git-bug.git",
			},
			want: want{
				owner:   "git-bug",
				project: "git-bug",
		...
		},
		{
			...
			args: args{
				url: "git://todo.sr.ht/git-bug/git-bug.git",
			},
			want: want{
				owner:   "git-bug",
				project: "git-bug",
